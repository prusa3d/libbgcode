...
namespace core {
    ...
    BGCODE_CORE_EXPORT std::string translate_result(EResult result) {
        ...
        case EResult::ReadError: {
            return "Read error";
        }
        case EResult::WriteError: {
            return "Write error";
        }
        case EResult::InvalidMagicNumber: {
            return "Invalid magic number";
        }
        case EResult::InvalidVersionNumber: {
            return "Invalid version number";
        }
        case EResult::InvalidChecksumType: {
            return "Invalid checksum type";
        }
        case EResult::InvalidBlockType: {
            return "Invalid block type";
        }
        case EResult::InvalidCompressionType: {
            return "Invalid compression type";
        }
        case EResult::InvalidMetadataEncodingType: {
            return "Invalid metadata encoding type";
        }
        case EResult::InvalidGCodeEncodingType: {
            return "Invalid gcode encoding type";
        }
        case EResult::DataCompressionError: {
            return "Data compression error";
        }
        case EResult::DataUncompressionError: {
            return "Data uncompression error";
        }
        case EResult::MetadataEncodingError: {
            return "Metadata encoding error";
        }
        case EResult::MetadataDecodingError: {
            return "Metadata decoding error";
        }
        case EResult::GCodeEncodingError: {
            return "GCode encoding error";
        }
        case EResult::GCodeDecodingError: {
            return "GCode decoding error";
        }
        case EResult::BlockNotFound: {
            return "Block not found";
        }
        case EResult::InvalidChecksum: {
            return "Invalid checksum";
        }
        case EResult::InvalidThumbnailFormat: {
            return "Invalid thumbnail format";
        }
        case EResult::InvalidThumbnailWidth: {
            return "Invalid thumbnail width";
        }
        case EResult::InvalidThumbnailHeight: {
            return "Invalid thumbnail height";
        }
        case EResult::InvalidThumbnailDataSize: {
            return "Invalid thumbnail data size";
        }
        case EResult::InvalidBinaryGCodeFile: {
            return "Invalid binary GCode file";
        }
        case EResult::InvalidAsciiGCodeFile: {
            return "Invalid ascii GCode file";
        }
        case EResult::InvalidSequenceOfBlocks: {
            return "Invalid sequence of blocks";
        }
        case EResult::AlreadyBinarized: {
    ...
    BGCODE_CORE_EXPORT size_t block_payload_size(const BlockHeader &block_header) {
        ...
        ret += ((ECompressionType)block_header.compression == ECompressionType::None) ? block_header.uncompressed_size : block_header.compressed_size;
        return ret;
    }
